...
CREATE TABLE `t_blog`  (
  ...
  `content` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '自然文章内容',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `first_picture` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '自然标题展示图片',
  `flag` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '文章类型：跟文章类型表相关联',
  `published` bit(1) NOT NULL,
  `recommend` bit(1) NOT NULL,
  `share_statement` bit(1) NOT NULL,
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '自然文章标题',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `views` int(11) NULL DEFAULT NULL COMMENT '浏览量',
  `type_id` bigint(20) NULL DEFAULT NULL COMMENT '文章设计领域ID',
  `user_id` bigint(20) NULL DEFAULT NULL COMMENT '发布者ID',
  `description` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '自然文章简介',
...
CREATE TABLE `t_flag`  (
  ...
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '文章类型',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of t_flag
-- ----------------------------
INSERT INTO `t_flag` VALUES (1, '原创');
INSERT INTO `t_flag` VALUES (2, '转载');
INSERT INTO `t_flag` VALUES (3, '翻译');
